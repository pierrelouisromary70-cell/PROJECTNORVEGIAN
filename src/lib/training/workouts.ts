...
const FR = {
  ...
  lt1_threshold: {
    title: 'Sous-seuil (LT1)',
    purpose: "Bâtir votre endurance à une intensité « soutenue mais conversationnelle ». Pierre angulaire de la méthode norvégienne — on accumule du temps utile sans s'épuiser.",
    feel: 'Effort soutenu mais contrôlé. Vous parlez par phrases courtes.',
    guidance: ['Ne jamais dépasser l\'allure prescrite — la régularité prime', 'Récupérations courtes en trot léger'],
  },
  lt2_threshold: {
    title: 'Seuil (LT2)',
    purpose: "Repousser votre seuil — l'intensité maximale tenable sur ~1 h.",
    feel: 'Inconfort contrôlé. Vous parlez par 2-3 mots maximum. 7/10 sur l\'échelle d\'effort.',
    guidance: ['Échauffement complet impératif (20 min)', 'Si vous craquez à mi-séance, vous étiez trop rapide depuis le début'],
  },
  vo2max: {
    title: 'VO2max',
